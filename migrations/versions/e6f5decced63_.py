...
Revision ID: e6f5decced63
Revises: c479e88f05b3
Create Date: 2022-02-24 19:54:59.107637
...
revision = 'e6f5decced63'
down_revision = 'c479e88f05b3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('edited', sa.String(length=80), nullable=True),
